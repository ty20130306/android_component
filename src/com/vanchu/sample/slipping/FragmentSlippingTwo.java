...
public class FragmentSlippingTwo extends Fragment{
	private final String TAG = FragmentSlippingTwo.class.getSimpleName();
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		SwitchLogger.d(TAG, TAG +" onCreateView");
		View view = inflater.inflate(R.layout.fragment_slipping_two, container,false);
		return view;
	}
